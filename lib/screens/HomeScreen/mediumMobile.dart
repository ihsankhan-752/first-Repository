...
mediumMobile(context) {
  ...
  return Scaffold(
    ...
    body: info.session == Sessions.previousSession
        ? Column(
        ...
        child: Row(
          children: [
            ...
            Text(
              "WELCOME\nTo Mediation Center",
              style: TextStyle(
                  fontSize: 18, color: Colors.blue, fontFamily: 'Pacifico'),
            )
          ],
        ),
      ),
              ...
              children: [
                InkWell(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 20,
                      color: info.session == Sessions.previousSession
                          ? Colors.white
                ...
                InkWell(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 20,
                      color: info.session == Sessions.myFavourite
                          ? Colors.white
                          : Colors.white.withOpacity(0.5),
                      fontFamily: 'Pacifico',
                    ),
