      ...
      children: [
        ...
        Padding(
          ...
          child: Align(
            ...
            child: Text("Forget Your Password ?",style: TextStyle(fontSize: 12,color: Colors.white),),
          ),
        ),
        Padding(
          padding: const EdgeInsets.only(top: 20,right: 16),
          child: Row(
            ...
            children: [
              ...
              Text(" Sign Up",style: TextStyle(fontSize: 12,color: Colors.black,fontWeight: FontWeight.bold),)
            ],
          ),
        ),
      ],
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        child:  Center(child: Text("SIGN IN",style: TextStyle(fontSize: 16,color: Colors.white),),),
      ),
    );
  }
}
